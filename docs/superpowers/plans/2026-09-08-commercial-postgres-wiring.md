...
- [x] **Step 3: 实现 PostgreSQL 租户与管理员读取**
...
- [x] **Step 6: 提交 PostgreSQL 租户与用量适配器**
...
- [x] **Step 4: 实现 PostgreSQL 生命周期作业存储**
...
- [x] **Step 3: 实现 `build_commercial_components`**
...
- [x] **Step 5: 运行 API 与 bootstrap 回归**
